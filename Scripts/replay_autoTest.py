...
try:
    ...
    lx.out(RED + "fileOpen failed: %s" % filename)
    traceback.print_exc()
...
try:
    ...
    lx.out(RED + "fileNew failed: %s" % filename)
    traceback.print_exc()
...
try:
    ...
    lx.out(RED + "fileInsert failed: %s" % filename)
    traceback.print_exc()
...
for test_file in test_files:
    ...
    try:
        ...
        lx.out(RED + "play failed: %s" % filename)
        traceback.print_exc()
    ...
    for export_format in ['lxm', 'py', 'json']:
        ...
        try:
            ...
            lx.out(RED + "Export failed: %s" % filename)
            traceback.print_exc()
    ...
    for export_format in ['lxm', 'py', 'json']:
        ...
        try:
            ...
            lx.out(RED + "Failed to re-open %s" % filename)
            traceback.print_exc()
        ...
        try:
            ...
            lx.out(RED + "Export failed: %s" % comparison_filename)
            traceback.print_exc()
